...
public class StackUtils {
    ...
    public static boolean itemsMatch(@Nonnull ItemStackCache cache, @Nullable ItemStack itemStack, boolean checkLore) {
        final boolean cacheEmpty = cache.getItemStack() == null || cache.getItemStack().getType() == Material.AIR;
        final boolean itemEmpty = itemStack == null || itemStack.getType() == Material.AIR;
        if (cacheEmpty || itemEmpty) {
            return cacheEmpty && itemEmpty;
        }
