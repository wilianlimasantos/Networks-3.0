...
public class NetworkConfigurator extends SlimefunItem {
                ...
                public void onRightClick(PlayerRightClickEvent e) {
                    ...
                    if (optional.isPresent()) {
                        ...
                        if (Slimefun.getProtectionManager().hasPermission(player, block, Interaction.INTERACT_BLOCK)
                            ...
                            player.sendMessage(Theme.ERROR + "É necessário mirar em uma interface direcional das Networks.");
                        }
                    }
                    e.cancel();
                }
    ...
    private void setConfigurator(@Nonnull NetworkDirectional directional, @Nonnull ItemStack itemStack, @Nonnull BlockMenu blockMenu, @Nonnull Player player) {
        ...
        if (blockFace == null) {
            player.sendMessage(Theme.ERROR + "Esta interface direcional ainda não tem direção definida");
            return;
        }
        ...
        player.sendMessage(Theme.SUCCESS + "Configuração copiada.");
    }
}
